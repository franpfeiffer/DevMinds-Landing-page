...
export function Header() {
    ...
    return (
        <div>
            <nav className="fixed top-0 left-0 right-0 z-10 bg-black bg-opacity-50 shadow-md flex items-center backdrop-blur-sn justify-between max-w-5xl p-2 mx-auto mt-2 rounded-xl md:py-8">
